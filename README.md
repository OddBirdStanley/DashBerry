...
- **Dual-camera H.264 recording** — 1080p30 front (CSI camera, hardware-encoded)
  and 1640×922@30 rear (Pi Zero UVC gadget, software-encoded), 60-second MPEG-TS
  segments, ~35 h of retention on a 256 GB card at 8 Mbps per camera. Setting up the rear
